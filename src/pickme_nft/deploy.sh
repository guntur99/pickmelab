...
#     record {  
#       token_id = 1 : nat;  
#       owner = opt record { owner = principal \"bkyz2-fmaaa-aaaaa-qaaaq-cai\"; subaccount = null;};  
#       metadata = variant {  
#         Class = vec {  
#           record {  
#             value = variant {  
...
# dfx canister call icrc7 icrc37_is_approved "(vec{record { spender=record {owner = principal \"xgu3d-chvj7-4ncnm-pkneh-hmd5s-o3uno-z27jx-dbau7-bpczp-blwzr-rae\"; subaccount = null;}; from_subaccount=null; token_id=0;}})" --query
...
# dfx canister call icrc7 icrc37_get_collection_approvals "(record { owner = principal \"bkyz2-fmaaa-aaaaa-qaaaq-cai\"; subaccount = null;},null, null)" --query
...
dfx canister call icrc7 icrc37_transfer_from "(vec{record { 
  ...
  created_at_time = null;}})"
# dfx canister call icrc7 icrc37_transfer_from "(vec{record { 
#   spender = principal \"xgu3d-chvj7-4ncnm-pkneh-hmd5s-o3uno-z27jx-dbau7-bpczp-blwzr-rae\";
#   from = record { owner = principal \"bkyz2-fmaaa-aaaaa-qaaaq-cai\"; subaccount = null}; 
#   to = record { owner = principal \"xgu3d-chvj7-4ncnm-pkneh-hmd5s-o3uno-z27jx-dbau7-bpczp-blwzr-rae\"; subaccount = null};
#   token_id =  0 : nat;
#   memo = null;
#   created_at_time = null;}})"
...
# dfx canister call icrc7 assign "(1, record { owner = principal \"xgu3d-chvj7-4ncnm-pkneh-hmd5s-o3uno-z27jx-dbau7-bpczp-blwzr-rae\"; subaccount = null})";
...
# dfx canister call icrc7 icrc37_approve_tokens "(vec {record { token_id=0; approval_info= record {from_subaccount = null; spender = record {owner = principal \"nnesd-k62jr-ytlzg-mb2yb-24xjk-7d5ki-yfkwo-2bair-cxrze-dwbe2-7qe\"; subaccount = null}; memo = null; expires_at = null; created_at_time = null }}})"
...
# dfx canister call icrc7 icrc37_is_approved "(vec { record {spender= record { owner = principal \"nnesd-k62jr-ytlzg-mb2yb-24xjk-7d5ki-yfkwo-2bair-cxrze-dwbe2-7qe\"; subaccount = null;}; from_subaccount=null; token_id=0}})" --query
...
# dfx canister call icrc7 icrc37_transfer_from "(vec {record { 
#   spender = principal \"nnesd-k62jr-ytlzg-mb2yb-24xjk-7d5ki-yfkwo-2bair-cxrze-dwbe2-7qe\";
#   from = record { owner = principal \"xgu3d-chvj7-4ncnm-pkneh-hmd5s-o3uno-z27jx-dbau7-bpczp-blwzr-rae\"; subaccount = null}; 
#   to = record { owner = principal \"qlhbo-objt4-fipo5-ysrjt-miwgi-now55-su54p-2waf7-xwalw-j2w6y-zae\"; subaccount = null};
#   token_id = 0 : nat;
#   memo = null;
#   created_at_time = null;}})"
...
# dfx canister call icrc7 icrc37_approve_collection "(vec {record { approval_info = record {from_subaccount = null; spender = record {owner = principal \"xgu3d-chvj7-4ncnm-pkneh-hmd5s-o3uno-z27jx-dbau7-bpczp-blwzr-rae\"; subaccount = null}; memo = null; expires_at = null; created_at_time = null }}})"
...
# dfx canister call icrc7 icrc37_get_collection_approvals "(record{owner = principal \"xgu3d-chvj7-4ncnm-pkneh-hmd5s-o3uno-z27jx-dbau7-bpczp-blwzr-rae\"; subaccount = null} ,null, null)" --query
